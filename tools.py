...
def pretrains(args,num,device,pretrain_path):
    ...
    os.makedirs('/home/wyx/pretrained/acc_teacher_all', exist_ok=True)
    torch.save(list_all, '/home/wyx/pretrained/acc_teacher_all/{}_{}_{}way.pth'.format(args.dataset, args.pre_backbone,
                                                                                        args.way_pretrain))
